...
class TestHomepage(TestBase):
    ...
    def test_homepage_elements(self):
        self.assertScreenCapture(self.homepage.element_title, self.imgRef.HOMEPAGE_ELEMENT_TITLE())
        self.assertScreenCapture(self.homepage.element_image, self.imgRef.HOMEPAGE_ELEMENT_IMAGE())
        self.assertScreenCapture(self.homepage.element_text, self.imgRef.HOMEPAGE_ELEMENT_TEXT())
